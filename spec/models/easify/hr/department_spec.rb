...
RSpec.describe Easify::Hr::Department, type: :model do
    ...
    it "should belong to a Easify::Hr::Company" do
       association = Easify::Hr::Department.reflect_on_association(:easify_hr_company)
    ...
    it "should have many Easify::Hr::HumanResources" do
       association = Easify::Hr::Department.reflect_on_association(:easify_hr_human_resources)
